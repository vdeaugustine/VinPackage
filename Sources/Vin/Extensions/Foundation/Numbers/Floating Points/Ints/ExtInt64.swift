...
public extension Int64 {
    ...
    ///
    /// This extension adds a computed property to the Int64 type that converts an integer to a string with a suffix indicating its position. The function addSuffixToNumber is called to add the appropriate suffix to the number based on its value.
    ...
    ///
    /// This extension adds a method to the Int64 type that checks whether the integer is a multiple of another specified integer. It does this by checking whether the remainder of the division of the two integers is zero.
