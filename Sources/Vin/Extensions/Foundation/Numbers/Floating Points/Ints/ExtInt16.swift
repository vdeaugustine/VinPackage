...
extension Int16 {
    /// An extension to the Int16 type that provides a computed property for converting an integer to a string with a suffix indicating the position of the number.
    ///
    /// - Returns: A String representation of the integer with a suffix indicating its position.
    ///
    /// This extension adds a computed property to the Int16 type that converts an integer to a string with a suffix indicating its position. The function addSuffixToNumber is called to add the appropriate suffix to the number based on its value.
    ...
    public var withSuffix: String {
        func addSuffixToNumber(_ number: Int16) -> String {
            let suffix: String
            switch number % 10 {
    ...
    /// An extension to the Int16 type that provides a method for checking whether one integer is a multiple of another.
    ///
    /// - Parameters:
    ...
    ///
    /// This extension adds a method to the Int16 type that checks whether the integer is a multiple of another specified integer. It does this by checking whether the remainder of the division of the two integers is zero.
    ...
    public func isMultiple(of other: Int16) -> Bool {
        self % other == 0
    }
